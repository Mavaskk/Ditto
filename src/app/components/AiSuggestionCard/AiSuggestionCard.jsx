...
import { getAiSuggestion } from "@/app/actions/actions";


export default function AiSuggestionCard({reccomandation,numberOfPartecipants,maxParticipantsNumber,isOrganizer}) {
