...
export default function page () {
    ...
    return (
        ...
        <h1 className="text-4xl mb-10 md:mb-0  text-balance font-semibold md:text-6xl xl:text-8xl text-center">Define  <span className="font-normal">your</span> trip</h1>
