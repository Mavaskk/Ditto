...
export default function Page () {
  ...
  return (
        ...
        <div className="flex mx-10 flex-col justify-center items-center pt-20 ">	
            <ConfimCard confirmData={"preferences"} destination={travelPrefences.destination} budget={travelPrefences.slider} travelPace={travelPrefences.travel_pace} vibe={travelPrefences.vibe} ></ConfimCard>
        </div>
